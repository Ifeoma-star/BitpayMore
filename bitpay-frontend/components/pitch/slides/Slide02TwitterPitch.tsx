  ...
  return (
    <SlideContainer background="white">
      <div className="text-center space-y-12">
        ...
        >
          <div className="p-6 bg-gradient-to-br from-orange-100 to-pink-100 rounded-3xl">
        ...
        >
          ...
          <p className="text-3xl md:text-4xl text-gray-700 font-medium max-w-4xl mx-auto leading-relaxed">
        ...
        <motion.div
          ...
          className="inline-block px-8 py-4 bg-gradient-to-r from-orange-50 to-pink-50 rounded-2xl border-2 border-orange-200"
        >
